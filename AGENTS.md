...
If your harness has a dedicated planning mode (Claude Code's plan mode), use it — it enforces steps 1–3 for you. Without one, do the same thing by hand: write the plan out, then stop.
