# Cebian Individual Contributor License Agreement

**[English](CLA.md) | [简体中文](CLA.zh-CN.md)**

Thank you for your interest in contributing to Cebian (the "Project"),
maintained by the owner of the GitHub repository at
<https://github.com/maotoumao/Cebian> (currently operated by the
individual known as "maotoumao" on GitHub), and their successors and
assigns (the "Maintainer").

We know reading a legal document isn't the most exciting part of
contributing. We've kept this CLA as short and standard as we
reasonably can — it's adapted from the well-known Apache CLA — so
that you can skim it quickly and get back to the fun part: writing
code. If anything in here is unclear, please open an issue and we're
happy to talk it through.

This Contributor License Agreement ("Agreement") documents the rights
granted by contributors to the Maintainer. To make this Agreement
effective, please follow the instructions in
[CONTRIBUTING.md](CONTRIBUTING.md). Because it's a legal document,
please read it carefully before agreeing to it.

This Agreement is based on the Apache Software Foundation Individual
Contributor License Agreement V2.0, with modifications appropriate for a
...
of, the Project. For the purposes of this definition, "submitted" means
any form of electronic, verbal, or written communication sent to the
Maintainer or its representatives, including but not limited to
communication on electronic mailing lists, source code control systems,
and issue tracking systems that are managed by, or on behalf of, the
Maintainer for the purpose of discussing and improving the Project, but
...
You further grant the Maintainer the right to **relicense** Your
Contribution under any license of the Maintainer's choosing, including
proprietary or commercial licenses, in addition to or in place of the
Project's then-current open source license. This includes the right to
change the open source license under which the Project (or Your
Contribution as part of the Project) is distributed, and to distribute
the Project under multiple licenses simultaneously. You understand and
agree that the Maintainer may, without any obligation to You, offer the
Project — or any portion of it, including Your Contribution — under
one or more licenses (for example, the Project's open source license
and a commercial license offered to paying customers).
...
- Each of Your Contributions is Your original creation (see Section 5
...
Thanks again for contributing to Cebian.
