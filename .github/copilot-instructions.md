...
3. **Code review after each task** — Immediately after finishing a subtask's implementation, invoke the `code-review` subagent on the changes for that subtask alone. Address any issues it raises before proceeding.
