...
//
// 住在 entrypoints/background/ 而非 lib/page-actions/：它要用 resolveProviderApiKey
// （本目录 agent.ts）解析凭证 + OAuth 刷新，lib 不反向 import entrypoints。经
...
import { resolveProviderApiKey } from './agent';
