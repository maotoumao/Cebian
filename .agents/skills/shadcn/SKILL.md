...
Before making changes, run `pnpm dlx shadcn@latest info --json`. Use the returned project config and installed-component list throughout the task. Use `pnpm dlx shadcn@latest docs <component>` to get documentation and example URLs for any component.
